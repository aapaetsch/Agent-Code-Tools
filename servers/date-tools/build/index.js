    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case 'parse': {
                        const result = DateTools.parse(args.dateString, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'format': {
                        const result = DateTools.format(args.date, args.format, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'convert': {
                        const result = DateTools.convert(args.dateString, args.fromFormat, args.toFormat, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'arithmetic': {
                        const result = DateTools.arithmetic(args.date, args.operations || []);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'compare': {
                        const result = DateTools.compare(args.date1, args.date2, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'info': {
                        const result = DateTools.info(args.date);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'validate': {
                        const result = DateTools.validate(args.dateString, args.format, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',

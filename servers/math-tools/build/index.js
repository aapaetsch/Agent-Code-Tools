    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case 'calculate': {
                        const result = MathTools.calculate(args.expression);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'compare': {
                        const result = MathTools.compare(args.num1, args.num2, args.operator);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'parse_numbers': {
                        const result = MathTools.parseNumbers(args.text, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'format_number': {
                        const result = MathTools.formatNumber(args.number, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'sanitize_number': {
                        const result = MathTools.sanitizeNumber(args.input, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'statistics': {
                        const result = MathTools.statistics(args.numbers);
                        return {
                            content: [
                                {
                                    type: 'text',

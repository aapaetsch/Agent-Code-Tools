...
export class StringTools {
     ...
     */
    static compare(str1, str2, method = 'exact') {
        try {
            let result;
            let description;
            switch (method) {
     ...
     */
    static transform(text, operations) {
        try {
            let result = text;
    ...
    static characterLevelDiff(str1, str2) {
    ...
    static wordLevelDiff(str1, str2) {

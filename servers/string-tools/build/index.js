    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                switch (name) {
                    case 'compare': {
                        const result = StringTools.compare(args.str1, args.str2, args.method || 'exact');
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'transform': {
                        const result = StringTools.transform(args.text, args.operations || []);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'analyze': {
                        const result = StringTools.analyze(args.text);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'diff': {
                        const result = StringTools.diff(args.str1, args.str2, args.options);
                        return {
                            content: [
                                {
                                    type: 'text',
                    ...
                    case 'validate': {
                        const result = StringTools.validate(args.text, args.rules || []);
                        return {
                            content: [
                                {
                                    type: 'text',
